 ...
 * SCL = PA1, SDA = PA2, slave addr 0x3C.
...
#define SCL_H()  GPIO_SetBits(GPIOA, SCL_PIN)
#define SCL_L()  GPIO_ResetBits(GPIOA, SCL_PIN)
#define SDA_H()  GPIO_SetBits(GPIOA, SDA_PIN)
#define SDA_L()  GPIO_ResetBits(GPIOA, SDA_PIN)
#define SDA_IN()  GPIO_ReadInputDataBit(GPIOA, SDA_PIN)
